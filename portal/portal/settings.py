...
from .secret import EMAIL_FOR_SEND_PASS, PASSWORD_FOR_SEND_PASS, KEY_FOR_IFRAME
...
EMAIL_PORT = 465
EMAIL_HOST_USER = EMAIL_FOR_SEND_PASS
EMAIL_HOST_PASSWORD = PASSWORD_FOR_SEND_PASS
EMAIL_USE_SSL = True
